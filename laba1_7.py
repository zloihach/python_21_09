...
data1 = sio.loadmat("./assets/dataset2.mat");
...
svm.visualize_boundary_linear(X2, y2, None, title="lab1_7_1")
svm.visualize_boundary_linear(Xval, yval, None, title="lab1_7_2")